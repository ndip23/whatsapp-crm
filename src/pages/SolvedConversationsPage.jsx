...
const SolvedConversationsPage = () => {
  // Sample data for solved conversations
          ...
          <table style={styles.table}>
            <thead style={styles.tableHeader}>
              <tr>
                ...
                <th style={styles.tableHeaderCell}>Resolution Time</th>
            ...
            <tbody style={styles.tableBody}>
              {currentConversations.map((conversation) => (
                <tr key={conversation.id} style={styles.tableRow}>
                  ...
                  <td style={{ ...styles.tableCell, ...styles.tableCellSecondary }}>{conversation.resolutionTime}</td>
                  <td style={{ ...styles.tableCell, ...styles.tableCellSecondary }}>{conversation.outcome}</td>
